...
class Population:
    ...
    def __init__(self, pop=[]):
        self.population = sorted(list(pop))
        if pop != []:
...
add_to_population = extend_population_unique
...
for _ in range(max_it):
    ...
    if new_population.population < pop_size:
        new_population = add_to_population(new_population, generate_population(pop_size - len(new_population.population)), population)
